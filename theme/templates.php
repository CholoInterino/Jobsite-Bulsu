 ...
 <head>
     <meta charset="utf-8">
     <title>BULSU / <?php echo $title;?></title>
     <meta name="viewport" content="width=device-width, initial-scale=1.0" />
     <meta name="description" content="" />
     <meta name="author" content="Bulsu Meneses Campus" />
     <!-- css -->
         ...
         <header>
             <div class="topbar navbar-fixed-top">
                 <div class="container">
                     <div class="row">
                         <div class="col-md-12">
                             <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>+639-1234-5678</p>
                     ...
                     <div class="col-md-4 col-sm-4">
                         <div class="widget">
                             ...
                             <address>
                                 ...
                                 TJS Matungao, Bulacan
                             </address>
                             <p>
                                 <i class="icon-phone"></i>+639-1234-5678-910<br>
                                 <i class="icon-envelope-alt"></i> bulsu@gmail.com
                             </p>
                         </div>
                     </div>
                     <div class="col-md-4 col-sm-4">
