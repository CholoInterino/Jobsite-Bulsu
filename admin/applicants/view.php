...
<form action="controller.php?action=approve" method="POST">
    ...
    <div class="col-sm-12 content-footer">
        ...
        <div class="col-sm-12 slider">
            <h3>Download Resume <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">Here</a>
            </h3>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <textarea class="input-group"
                name="REMARKS"><?php echo isset($jobreg->REMARKS) ? $jobreg->REMARKS : ""; ?></textarea>
        </div>
