...
<form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <input class="form-control input-sm" id="FNAME" name="FNAME" placeholder="Firstname" type="text"
                    value="<?php echo $emp->FNAME;?>" autocomplete="off">
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <input class="form-control input-sm" id="LNAME" name="LNAME" placeholder="Lastname"
                    value="<?php echo $emp->LNAME;?>" autocomplete="off">
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <input class="form-control input-sm" id="MNAME" name="MNAME" placeholder="Middle Name"
                    value="<?php echo $emp->MNAME;?>" autocomplete="off">
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                ...
                <textarea class="form-control input-sm" id="ADDRESS" name="ADDRESS" placeholder="Address" type="text"
                    value="" required autocomplete="off"><?php echo $emp->ADDRESS;?></textarea>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-8">
                <div class="input-group">
                    ...
                    <input class="form-control input-sm date_picker" id="BIRTHDATE" name="BIRTHDATE"
                        ...
                        value="<?php echo date_format(date_create($emp->BIRTHDATE),'m/d/Y');?>" required
                        autocomplete="off">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                ...
                <textarea class="form-control input-sm" id="BIRTHPLACE" name="BIRTHPLACE" placeholder="Place of Birth"
                    type="text" value="" required autocomplete="off"><?php echo $emp->BIRTHPLACE;?></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                ...
                <input class="form-control input-sm" id="TELLNO" name="TELLNO" placeholder="Contact No." type="text" any
                    value="<?php echo $emp->TELLNO;?>" required autocomplete="off">
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                ...
                <input class="form-control input-sm" id="POSITION" name="POSITION" placeholder="Postion" type="text" any
                    value="<?php echo $emp->POSITION;?>" required autocomplete="off">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-8">
            <label class="col-md-4 control-label" for="WORKSTATUS">Work Status:</label>
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <div class="input-group date  " data-provide="datepicker" data-date="2012-12-21T15:25:00Z">
                    <input type="input" class="form-control input-sm date_picker" id="HIREDDATE" name="EMP_HIREDDATE"
                        placeholder="mm/dd/yyyy" autocomplete="false"
                        value="<?php echo date_format(date_create($emp->DATEHIRED),'m/d/Y'); ?>" />
