...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">List of Employee's <a href="index.php?view=add" class="btn btn-primary btn-xs  "> <i
                    class="fa fa-plus-circle fw-fa"></i> Add New Employee</a> </h1>
    </div>
    <!-- /.col-lg-12 -->
</div>

<form class="wow fadeInDownaction" action="controller.php?action=delete" Method="POST">
    <table id="dash-table" class="table table-striped  table-hover table-responsive" style="font-size:12px"
        cellspacing="0">
        ...
        <tbody>
            <?php
            $mydb->setQuery("SELECT e.*, c.COMPANYNAME 
                            FROM `tblemployees` e 
            ...
            foreach ($cur as $result) {
                ...
                echo '<td>' . $result->TELLNO . '</td>';
                echo '<td>' . $result->POSITION . '</td>';
                echo '<td>' . $result->WORKSTATUS . '</td>';
