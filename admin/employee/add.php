                ...
                <form class="form-horizontal span6  wow fadeInDown" action="controller.php?action=add" method="POST">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                              ...
                              "Employee No" type="text" value="<?php echo $res->AUTO; ?>"> -->
                                <input class="form-control input-sm" id="EMPLOYEEID" name="EMPLOYEEID"
                                    placeholder="Employee ID" type="text" value="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control input-sm" id="ADDRESS" name="ADDRESS"
                                    placeholder="Address" type="text" value="" required autocomplete="off"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-lg-4">
                                    <div class="radio">
                                        <label><input id="optionsRadios2" name="optionsRadios" type="radio"
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input class="form-control input-sm date_picker" id="BIRTHDATE" name="BIRTHDATE"
                                        placeholder="Date of Birth" type="text" value="" required autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                ...
                                <input class="form-control input-sm" id="TELLNO" name="TELLNO" placeholder="Contact No."
                                    type="text" any value="" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                ...
                                <input class="form-control input-sm" id="POSITION" name="POSITION" placeholder="Postion"
                                    type="text" any value="" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                <div class="input-group date  " data-provide="datepicker"
                                    ...
                                    <input type="input" class="form-control input-sm date_picker" id="HIREDDATE"
                                        name="EMP_HIREDDATE" placeholder="mm/dd/yyyy" autocomplete="false" />
                    ...
                    <div class="form-group">
                        <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                <input type="Email" class="form-control input-sm" id="EMP_EMAILADDRESS"
                                    name="EMP_EMAILADDRESS" placeholder="Email Address" autocomplete="false" />
                            </div>
                        </div>
                    </div>
