...
<form class="form-horizontal span6" action="controller.php?action=add" method="POST">
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <input class="form-control input-sm" id="COMPANYNAME" name="COMPANYNAME" placeholder="Company Name"
                    type="text" value="" autocomplete="none">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <textarea class="form-control input-sm" id="COMPANYADDRESS" name="COMPANYADDRESS"
                ...
                <!-- <input class="form-control input-sm" id="COMPANYADDRESS" name="COMPANYADDRESS"
                    placeholder="Company Address" autocomplete="none" /> -->
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <input class="form-control input-sm" id="COMPANYCONTACTNO" name="COMPANYCONTACTNO"
                    placeholder="Company Contact No." type="text" value="" autocomplete="none">
            </div>
        </div>
    </div>
